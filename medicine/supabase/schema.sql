...
-- Note: The original login_activity table setup was missing, adding it here or ensuring it exists
-- In this project, it seems health_metrics was used for some activity, but let's add login_activity
